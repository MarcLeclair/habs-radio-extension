...
import io.github.habsradiosync.androidcommonui.HrsBufferDelayBar
import io.github.habsradiosync.androidcommonui.HrsMetric
import io.github.habsradiosync.shared.HRS_PRIVACY_DETAILS
import io.github.habsradiosync.shared.HRS_PRIVACY_SUMMARY
...
fun FirstRunDialog(onDismiss: () -> Unit) {
    InfoDialog(
        title = "First run",
        body = "Install and open Habs Radio Sync on your TV first. Then open this remote on your phone. It will look for the TV on the same Wi-Fi. If discovery does not find it, enter the TV IP address manually.",
        onDismiss = onDismiss,
    )
}
