...
The TV app exposes a local control API on your network so the phone remote can send playback, delay, and volume commands.

## Internet Access

The TV app connects to radio stream URLs (StreamTheWorld).

## Notifications

The TV app uses notifications for playback status.
...
For privacy questions about this app, contact: malclir@proton.me
