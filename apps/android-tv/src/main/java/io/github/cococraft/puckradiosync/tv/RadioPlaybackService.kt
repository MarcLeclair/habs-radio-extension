...
import io.github.cococraft.puckradiosync.shared.RemoteCommand
import io.github.cococraft.puckradiosync.shared.applyCommand
...
class RadioPlaybackService : Service() {
    ...
    companion object {
        const val ACTION_PLAY = "io.github.cococraft.puckradiosync.tv.PLAY"
        const val ACTION_PAUSE = "io.github.cococraft.puckradiosync.tv.PAUSE"
        const val ACTION_STOP = "io.github.cococraft.puckradiosync.tv.STOP"

        private const val TAG = "PuckRadioSync"
