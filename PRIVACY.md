...
The extension does not include analytics, telemetry, or tracking of any kind.

Your settings (chosen station, delay value, custom domains you have added) are stored locally in your browser using the standard extension storage API. They never leave your device.

Contact: malclir@proton.me
